...
const EditPopup = ({homeImg}) => {
    ...
    const handleUpdate = async (e) => {
        ...
        console.log(data)
        const response = await fetch('/home-api/update-home-main-events-image/json/'+ homeImg._id, {
            method: 'PUT',
            body: data,
            headers: {
    ...
    const handleDelete = async (e) => {
        ...
        const response = await fetch('/home-api/delete-single-home-main-events-image/json/'+ homeImg._id, {
            method: 'DELETE',
            headers: {
                'Authorization': `Bearer ${user.token}`
            }
