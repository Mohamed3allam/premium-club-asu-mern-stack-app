...
const MultipleUploadPopup = () => {
    ...
    const handleUpload = async (e) => {
        ...
        const response = await fetch(`${premiumApi}/home-api/upload-home-main-event-images`, {
            method: 'POST',
            body: data,
            headers: {
                    ...
                    <EditForm style={{flexDirection: uploadedOrientation}}>
                        {!uploadedImages && (
                            <EditImage>
                                ...
                                <EditImgInput multiple='multiple'onChange={changeImgPreviewHandler} style={{display:'none'}} id='uploadedImages' type='file' accept='image/*' />
                            </EditImage>
                        )}
                        {uploadedImages && (
