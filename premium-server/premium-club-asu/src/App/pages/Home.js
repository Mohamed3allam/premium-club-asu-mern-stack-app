...
`
const Home = ({homeSections, homeImgs, images}) => {
    ...
    return ( 
        ...
        <HelmetProvider>
            ...
            <div>
                ...
                {
                    homeSections && homeSections.map((section)=>{return(
                            ...
                            <div className="row py-5" >
                                ...
                                <div className="row pb-5">
                                    ...
                                    <Carousel fade id='carouselExampleCrossfade' >
                                        {
                                            homeImgs && homeImgs.map((homeImg) => (
                                                <Carousel.Item key={homeImg._id}>
                                                    <img
                                                        className="d-block w-100"
                                                        src={premiumApi + homeImg.imageUrl}
                                                        alt="slide"
                                                    />
                                                    <Carousel.Caption>
                                                        <h3><b>{homeImg.eventName.toUpperCase()}</b></h3>
                                                    </Carousel.Caption>
                                                </Carousel.Item>
                                            ))
                                        }
